...
export const Header_MenuBar = () => {
  ...
  return(
    <nav className={styles.single_menu_bar}>
      <div></div>
    <ul className={styles.single_menu_bar_items}>
      <li onMouseEnter={handleHoverTab1} onMouseLeave={handleHoverTab1} className={styles.single_menu_tab}>
        <Link href={"/gaiyou"}>会社概要</Link>{isHoveredTab1 && (
          <ul className={styles.sub_menu}>
                <li className={styles.sub_menu_item}><Link href={"/rinen"}>経営理念</Link></li>
                <li className={styles.sub_menu_item}><Link href={"/panflet"}>会社資料</Link></li>
                <li className={styles.sub_menu_item}><Link href={"/range"}>事業領域</Link></li>
        </ul>
      )}</li>
      ...
      {isHoveredTab2 && (
        ...
        <li className={styles.sub_menu_item}><Link href={"/system"}>社内制度</Link></li>
        <li className={styles.sub_menu_item}><Link href={"/constitution"}>MIKの構成</Link></li>
        <li className={styles.sub_menu_item}><Link href={"/people"}>MIKの人々</Link></li>
        <li className={styles.sub_menu_item}><Link href={"/gyoumu"}>配属先と業務</Link></li>
        <li className={styles.sub_menu_item}><Link href={"/charge_up"}>収入アップ実績</Link></li>
      ...
      <li className={styles.single_menu_tab}><Link href={"/blog"}>ブログ</Link></li>
