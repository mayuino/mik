...
export const Content_Recruit_Detail = () =>{
  ...
  return(
   ...
   <button className={styles.oubo_button}>応募する</button>
      </div>
...
※住宅手当・社宅については応相談</p>
 ...
 <div className={styles.oubo_button_wrapper}><a href='/oubo' className={styles.oubo_button}>応募する</a></div>
