...
useEffect(() => {
  ...
  return (
    ...
    <div
      className={`${styles.top} ${mobileStyles.top}`}
    >
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet"></link>
     <img　className={`${styles.top_sapporo} ${mobileStyles.top_sapporo}`} src="/images/new2024/sapporo-city2.png" alt="sapporo_city_photo"/>
...
chevron_right
    ...
    <div className={`${styles.joblist_wrapper} ${mobileStyles.joblist_wrapper}`}>
     <ul className={`${styles.joblist} ${mobileStyles.joblist}`}>
      <li><div className={`${styles.job_box} ${mobileStyles.job_box}`}>
     
        <img　className={`${styles.job_images} ${mobileStyles.job_images}`} src="/images/new2024/job/webdev.png" alt="web"/>
     <div className={styles.job_name}><h6>WEB/ソフトウェア</h6></div>
       </div></li>

       <li><div className={`${styles.job_box} ${mobileStyles.job_box}`}>
        <img　className={`${styles.job_images} ${mobileStyles.job_images}`} src="/images/new2024/job/idoutai.png" alt="web"/>
     <div className={styles.job_name}><h6>移動体通信</h6></div>
       </div></li>

       <li><div className={`${styles.job_box} ${mobileStyles.job_box}`}>
        <img　className={`${styles.job_images} ${mobileStyles.job_images}`} src="/images/new2024/job/kensetsu.png" alt="web"/>
     <div className={styles.job_name}><h6>建築</h6></div>
       </div></li>

       <li><div className={`${styles.job_box} ${mobileStyles.job_box_disable}`}>
        <img　className={`${styles.job_images} ${mobileStyles.job_images}`} src="/images/new2024/job/handoutai.png" alt="web"/>
     <div className={styles.job_name}><h6>半導体</h6></div>
       </div></li>

       <li><div className={`${styles.job_box} ${mobileStyles.job_box_disable}`}>
        <img　className={`${styles.job_images} ${mobileStyles.job_images}`} src="/images/new2024/job/drone.png" alt="web"/>
     <div className={styles.job_name}><h6>ドローン</h6></div>
       </div></li>

       <li><div className={`${styles.job_box} ${mobileStyles.job_box_disable}`}>
        <img　className={`${styles.job_images} ${mobileStyles.job_images}`} src="/images/new2024/job/server.png" alt="web"/>
     <div className={styles.job_name}><h6>サーバー管理</h6></div>
       </div></li>

       <li><div className={`${styles.job_box} ${mobileStyles.job_box_disable}`}>
        <img　className={`${styles.job_images} ${mobileStyles.job_images}`} src="/images/new2024/job/helpdesk.png" alt="web"/>
